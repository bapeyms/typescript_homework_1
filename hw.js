...
let toPower = myPower(baseNumber, exponentNumber);
...
let number1 = 5;
let number2 = 9;
let result6 = sumOfRange(number1, number2);
...
let checkIsAlphanumeric = "ABC123";
let result7 = isAlphanumeric(checkIsAlphanumeric);
